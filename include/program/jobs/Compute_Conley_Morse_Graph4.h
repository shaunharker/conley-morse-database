...
void Compute_Conley_Morse_Graph4 ( Conley_Morse_Graph * conley_morse_graph ,
  Toplex * phase_space,
...
#include "program/jobs/Compute_Conley_Morse_Graph4.hpp"
#endif
