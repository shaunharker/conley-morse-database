...
int SINGLECMG_MAX_PHASE_SUBDIVISIONS = 22;
...
#ifdef PRISMFISHERIES3D
#include "data/fisheries3d/ModelMap.h"
Rect initialize_phase_space_box ( void ) {
  // Two dimensional phase space                                                                                                                              
  // [0, 320.056] x [0.0, 224.040]                                                                                                                            
  //  int phase_space_dimension = 2;                                                                                                                          
...
#ifdef PRISMFISHERIES4D
#include "data/fisheries4d/ModelMap.h"
Rect initialize_phase_space_box ( void ) {
  // Two dimensional phase space                                                                                                                                        
  // [0, 320.056] x [0.0, 224.040]                                                                                                                                      
  //  int phase_space_dimension = 2;                                                                                                                                    
...
#ifdef PRISMFISHERIES5D
#include "data/fisheries5d/ModelMap.h"
Rect initialize_phase_space_box ( void ) {
  // Two dimensional phase space  
...
#ifdef PRISMFISHERIES6D
#include "data/fisheries6d/ModelMap.h"
Rect initialize_phase_space_box ( void ) {
  // Two dimensional phase space                                                                                                                                             
...
#endif
#ifdef FOURDIMPRISMLESLIE
#include "data/prismleslie4d/ModelMap.h"
...
#include "data/prismleslie5d/ModelMap.h"
...
int main ( int argc, char * argv [] ) 
{
  ...
  std::vector < Rect > markedRect;
  
  {
  Rect r ( 4 );
  r . lower_bounds [ 0 ] = 0.0; r . upper_bounds [ 0 ] = 0.0;
  r . lower_bounds [ 1 ] = 0.0; r . upper_bounds [ 1 ] = 0.0;
  r . lower_bounds [ 2 ] = 0.0; r . upper_bounds [ 2 ] = 0.0;
  r . lower_bounds [ 3 ] = 0.0; r . upper_bounds [ 3 ] = 0.0;
  markedRect . push_back ( r );
  }
  
  {
  Rect r ( 4 );
  r . lower_bounds [ 0 ] = 0.000161381; r . upper_bounds [ 0 ] = 0.000161383;
  r . lower_bounds [ 1 ] = 0.000097882; r . upper_bounds [ 1 ] = 0.000097884;
  r . lower_bounds [ 2 ] = 0.000059368; r . upper_bounds [ 2 ] = 0.000059370;
  r . lower_bounds [ 3 ] = 0.000036008; r . upper_bounds [ 3 ] = 0.000036010;
  markedRect . push_back ( r );
  }
  
  std::vector < CellContainer > marked;
  BOOST_FOREACH ( const Rect & r, markedRect ) {
  marked . push_back ( CellContainer () );
  std::insert_iterator<CellContainer> ii ( marked . back (), marked.back().begin() );
  phase_space . cover ( ii, r );
  }
