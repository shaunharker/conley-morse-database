...
$sqlquery="select PERMUTATIONS.PERMUTATIONDIR,COUNT(MORSEGRAPHS.PERCENTAGE),ROUND(100.0*MIN(MORSEGRAPHS.PERCENTAGE),2)";
$sqlquery .= ",ROUND(100.0*MAX(MORSEGRAPHS.PERCENTAGE),2),ROUND(100.0*SUM(MORSEGRAPHS.PERCENTAGE),2)";
$sqlquery .= " FROM MORSEGRAPHS";
$sqlquery .= " INNER JOIN PERMUTATIONS ON PERMUTATIONS.PERMUTATIONID=MORSEGRAPHS.PERMUTATIONID";
$sqlquery .= " INNER JOIN MORSESETS ON MORSEGRAPHS.PERMUTATIONID=MORSESETS.PERMUTATIONID AND MORSEGRAPHS.MORSEGRAPHID=MORSESETS.MORSEGRAPHID ";
